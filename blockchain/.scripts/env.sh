...
export EOSIO_PRIVATE_KEY=$(cat /root/eosio-wallet/eosio_key.txt | grep -oP "Private key: \K[^\n]*")
export EOSIO_PUBLIC_KEY=$(cat /root/eosio-wallet/eosio_key.txt | grep -oP "Public key: \K[^\n]*")
