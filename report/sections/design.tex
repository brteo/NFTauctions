...
\bigbreak
\noindent
Luca ha 16 anni e gli piace disegnare, lo fa di continuo, anche a scuola durante le lezioni che lo annoiano.
Non sa se farà l'università, non gli piace nessun lavoro, gli piace solo disegnare ma in questo periodo storico sa già che sarò difficile renderlo un lavoro.

\underline{Scenario d'uso:}
Tra gli amici di Luca gira voce di questi nuovi NFT, dei token digitali che scambiarsi opere digitali,
ci sono persone che con i CryptoKitties hanno fatto un sacco di soldi! 
Luca sul treno di ritorno da scuola, tramite il suo cellulare cerca di informarsi e scopre il portale.
...
La fotografia è la sua passione ma a è al servizio di altri che lo pagano per fare servizi.
